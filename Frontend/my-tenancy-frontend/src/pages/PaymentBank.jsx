...
export default function PaymentBank() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!amount) {
      setError("No payment amount found. Please go back and enter an amount.");
      return;
    }

    if (!proof) {
      setError("Please upload proof of bank transfer.");
      return;
    }
    ...
    try {
      ...
      setSuccess("Bank transfer proof uploaded successfully!");
      localStorage.removeItem("pending_payment_amount");
      navigate("/tenant/payments");
    } catch (err) {
      console.error("Error submitting bank transfer:", err);
      setError("Failed to submit bank payment. Please try again.");
    } finally {
      setUploading(false);
    }
  };
      ...
      <main className="container mx-auto px-4 py-8 max-w-lg">
        ...
        <div className="bg-white p-6 rounded-xl shadow-md">
          ...
          <div className="mb-4 text-gray-700">
            ...
            <p><strong>Account Name:</strong> Tenancy System Inc.</p>
          ...
          <form onSubmit={handleSubmit}>
            ...
            >
              {uploading ? "Uploading..." : "Submit Bank Proof"}
            </button>
          </form>
        </div>
      </main>
